...
from trackers.siamfc.siamfc_net import SiamFC
...
class SiamFCTracker(BaseTracker):
    ...
    def __init__(self, weights_path, **kargs):
        ...
        self.net = SiamFC()
        self.net.load_state_dict(torch.load(weights_path, map_location=lambda storage, _: storage))
        print ("Load model {} -- Done".format(weights_path))
    ...
    def update(self, image):
        ...
        confidence = calculate_psr(response, exclude_radius=3, rolled=False)
